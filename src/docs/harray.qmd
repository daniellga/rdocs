...
`new_from_values(arr: array, dtype: HDataType) -> HArray` <span style="float: right;"> [source](www.gh.com/testdir/harray.rs#L45) </span> \
...
`len() -> integer` <span style="float: right;"> [source](www.gh.com/testdir/harray.rs#L113) </span> \
...
`shape() -> integers` <span style="float: right;"> [source](www.gh.com/testdir/harray.rs#L141) </span> \
...
`ndim() -> integer` <span style="float: right;"> [source](www.gh.com/testdir/harray.rs#L169) </span> \
...
`slice(range: list[atomicvector]) -> HArray` <span style="float: right;"> [source](www.gh.com/testdir/harray.rs#L207) </span> \
...
`print()` <span style="float: right;"> [source](www.gh.com/testdir/harray.rs#L233) </span> \
...
`eq(other: HArray) -> bool` <span style="float: right;"> [source](www.gh.com/testdir/harray.rs#L274) </span> \
...
`ne(other: HArray) -> bool` <span style="float: right;"> [source](www.gh.com/testdir/harray.rs#L317) </span> \
...
`clone() -> HArray` <span style="float: right;"> [source](www.gh.com/testdir/harray.rs#L346) </span> \
...
`collect() -> array` <span style="float: right;"> [source](www.gh.com/testdir/harray.rs#L372) </span> \
...
`dtype() -> HDataType` <span style="float: right;"> [source](www.gh.com/testdir/harray.rs#L398) </span> \
...
`is_shared() -> bool` <span style="float: right;"> [source](www.gh.com/testdir/harray.rs#L429) </span> \
...
`mem_adress() -> string` <span style="float: right;"> [source](www.gh.com/testdir/harray.rs#L458) </span> \
