...
`new_from_values(arr: array, dtype: HDataType) -> HArray` <span style="float: right;"> [source](aaa.github.comharray.rs#L45) </span> \
...
`len() -> integer` <span style="float: right;"> [source](aaa.github.comharray.rs#L113) </span> \
...
`shape() -> integers` <span style="float: right;"> [source](aaa.github.comharray.rs#L141) </span> \
...
`ndim() -> integer` <span style="float: right;"> [source](aaa.github.comharray.rs#L169) </span> \
...
`slice(range: list[atomicvector]) -> HArray` <span style="float: right;"> [source](aaa.github.comharray.rs#L207) </span> \
...
`print()` <span style="float: right;"> [source](aaa.github.comharray.rs#L233) </span> \
...
`eq(other: HArray) -> bool` <span style="float: right;"> [source](aaa.github.comharray.rs#L274) </span> \
...
`ne(other: HArray) -> bool` <span style="float: right;"> [source](aaa.github.comharray.rs#L317) </span> \
...
`clone() -> HArray` <span style="float: right;"> [source](aaa.github.comharray.rs#L346) </span> \
...
`collect() -> array` <span style="float: right;"> [source](aaa.github.comharray.rs#L372) </span> \
...
`dtype() -> HDataType` <span style="float: right;"> [source](aaa.github.comharray.rs#L398) </span> \
...
`is_shared() -> bool` <span style="float: right;"> [source](aaa.github.comharray.rs#L429) </span> \
...
`mem_adress() -> string` <span style="float: right;"> [source](aaa.github.comharray.rs#L458) </span> \
