...
`download_rdocs()` <span style="float: right;"> [source](https://github.com/daniellga/rdocs/tree/main/rdocs/Rmain.R#L44) </span> \
...
`generate_docs(files, folder_name = "docs", gh_url = "", run_examples = FALSE)` <span style="float: right;"> [source](https://github.com/daniellga/rdocs/tree/main/rdocs/Rmain.R#L103) </span> \
